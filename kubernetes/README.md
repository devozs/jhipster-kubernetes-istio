...
```
$ docker image tag ui acrdevozs/ui
$ docker push acrdevozs/ui
$ docker image tag organization acrdevozs/organization
$ docker push acrdevozs/organization
$ docker image tag leave acrdevozs/leave
$ docker push acrdevozs/leave
$ docker image tag meeting acrdevozs/meeting
$ docker push acrdevozs/meeting
$ docker image tag notification acrdevozs/notification
$ docker push acrdevozs/notification
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n office
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n office
```
